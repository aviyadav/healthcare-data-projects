...
from ..models import AERecord, PaginatedResponse

router = APIRouter(tags=["Adverse Events (AE)"])
...
@router.get(
    ...
    operation_id="get_adverse_events_api_v1_ae_get",
)
def get_adverse_events(
    ...
    records, total = query_domain(
        domain_path=settings.data_root / "AE",
        domain="AE",
        filters={
            "study": study,
            "site": site,
