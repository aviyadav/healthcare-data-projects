...
from ..models import DMRecord, PaginatedResponse

router = APIRouter(tags=["Demographics (DM)"])
...
@router.get(
    ...
    operation_id="get_demographics_api_v1_dm_get",
)
def get_demographics(
    ...
    records, total = query_domain(
        domain_path=settings.data_root / "DM",
        domain="DM",
        filters={
            "study": study,
            "site": site,
