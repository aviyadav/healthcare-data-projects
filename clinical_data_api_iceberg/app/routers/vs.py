...
from ..models import PaginatedResponse, VSRecord

router = APIRouter(tags=["Vital Signs (VS)"])
...
@router.get(
    ...
    operation_id="get_vital_signs_api_v1_vs_get",
)
def get_vital_signs(
    ...
    records, total = query_domain(
        domain_path=settings.data_root / "VS",
        domain="VS",
        filters={
            "study": study,
            "site": site,
