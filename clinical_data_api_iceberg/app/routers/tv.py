...
from ..models import PaginatedResponse, TVRecord

router = APIRouter(tags=["Trial Visits (TV)"])
...
@router.get(
    ...
    operation_id="get_trial_visits_api_v1_tv_get",
)
def get_trial_visits(
    ...
    records, total = query_domain(
        domain_path=settings.data_root / "TV",
        domain="TV",
        filters={
            "study": study,
            "site": site,
